...
urlpatterns = [
    ...
    url(r'^product_index/(?P<aid>\d+)$', views.product_index, name="product"),
    url(r'^product_detail/(?P<aid>\d+)$', views.product_detail, name="product"),
    # url(r'^facility/$', views.faclity_index, name="faclity"),
    url(r'^jobs/$', views.jobs_index, name="jobs"),
    url(r'^admin/', admin.site.urls),
    url(r'^contact/$', views.contact, name="contact"),
    url(r'^contact1/$', views.ajax_contact, name="contact"),
